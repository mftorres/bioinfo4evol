...
Once active, you should see it in the left side of the prompt's line. **Anything that you install whilst an environment is active will only be available for that environment.**
